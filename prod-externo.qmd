...
* Nesta seção e na próxima, para lembrar que estamos trabalhando com $\ve1$ e com $\ve2$, vamos rotular os eixos $x$ e $y$ dos nossos gráficos com os nomes destes dois vetores, como na @fig-e1-e2. 
...
* [A orientação depende da ordem dos vetores]{.hl}. A @fig-area-r2-2 mostra a área orientada definida pelos [mesmos vetores]{.hl} $\vet w = 3\ve1 - \ve2$ e $\vet v = \ve1 + 2\ve2$, [na ordem inversa]{.hl} da @fig-area-r2. A orientação, agora, é no sentido anti-horário.
  ...
  ![Área orientada definida por $\vet v$ e $\vet w$ (nesta ordem)](figures/fig-area-r2.png){width=60% fig-alt="Área orientada." #fig-area-r2}

  ![Área orientada definida por $\vet w$ e $\vet v$ (nesta ordem)](figures/fig-area-r2-2.png){width=55% fig-alt="Área orientada." #fig-area-r2-2}
...
* No exemplo da @fig-area-r2, o peso do bivetor é $-7$, se convencionarmos que a orientação no sentido horário corresponde a áreas negativas.

* No exemplo da @fig-area-r2-2, o peso do bivetor é $7$, se convencionarmos que a orientação no sentido anti-horário corresponde a áreas positivas.
