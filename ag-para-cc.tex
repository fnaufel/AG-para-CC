...
\item
  ...
  \begin{tcolorbox}[standard jigsaw,toprule=.15mm, bottomrule=.15mm, bottomtitle=1mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Notação: vetores como combinações lineares dos vetores da base}, opacitybacktitle=0.6, left=2mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, colback=white, rightrule=.15mm, leftrule=.75mm, colframe=quarto-callout-warning-color-frame]
