...
\item
  ...
  \begin{tcolorbox}[standard jigsaw,titlerule=0mm, bottomtitle=1mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Notação: vetores como combinações lineares dos vetores da base}, rightrule=.15mm, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, opacityback=0, colback=white, leftrule=.75mm, toprule=.15mm]
...
\item
  ...
  {\centering \includegraphics[width=1\textwidth,height=\textheight]{figures/bivetor-vw.jpg}
...
\item
  ...
  aplicações, {\hl{podemos interpretar um bivetor como um subespaço do
  plano}}.
\end{itemize}
