...
\item
  ...
  \begin{tcolorbox}[standard jigsaw,title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Notação: vetores em negrito}, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, left=2mm, toptitle=1mm, titlerule=0mm, arc=.35mm, coltitle=black, toprule=.15mm, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, colback=white, leftrule=.75mm, opacitybacktitle=0.6]
...
\item
  ...
  {\centering \includegraphics[width=0.7\textwidth,height=\textheight]{figures/vetores-base.png}
  ...
  \begin{tcolorbox}[standard jigsaw,title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Notação: vetores como combinações lineares dos vetores da base}, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, left=2mm, toptitle=1mm, titlerule=0mm, arc=.35mm, coltitle=black, toprule=.15mm, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, colback=white, leftrule=.75mm, opacitybacktitle=0.6]
  ...
  \end{tcolorbox}
\item
  Para acompanhar o restante deste capítulo, você deve revisar os
  seguintes tópicos sobre vetores, especialmente em $\mathbb{R}^2$ e em
  $\mathbb{R}^3$:
...
\item
  ...
  \begin{tcolorbox}[standard jigsaw,title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Resumindo: vetores \(=\) retas homogêneas orientadas e com peso}, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, left=2mm, toptitle=1mm, titlerule=0mm, arc=.35mm, coltitle=black, toprule=.15mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, colback=white, leftrule=.75mm, opacitybacktitle=0.6]
  Um vetor \[
...
\hypertarget{n-1-vetores-em-mathbbrn}{%
\section{\texorpdfstring{$n + 1$-vetores em
$\mathbb{R}^n$?}{-vetores em ?}}\label{n-1-vetores-em-mathbbrn}}
