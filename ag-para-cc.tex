...
\item
  ...
  \begin{tcolorbox}[standard jigsaw,colframe=quarto-callout-warning-color-frame, toptitle=1mm, colback=white, bottomtitle=1mm, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, opacityback=0, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Notação: vetores como combinações lineares dos vetores da base}, left=2mm]
